package indi.muleisy.ra.service.ebusiness.product.config;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, String> consumerFactory() {
        ...
        configProps.put(org.apache.kafka.clients.consumer.ConsumerConfig.GROUP_ID_CONFIG, "user-account-group");
